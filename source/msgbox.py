...
class MsgBox(ModalView):
    ...
    def build_layout(self):
        ...
        if self.type == 'question':
            self.yes_button = self.MsgBox_Button(text="Oui", font_size=self.font_size, type='yes')
            self.no_button = self.MsgBox_Button(text="Non", font_size=self.font_size, type='no')
